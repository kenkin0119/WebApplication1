...
namespace Tour.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AttrationID,MemberID,Contents,Photos,DateTime,Rate")] Comments comments)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AttrationID,MemberID,Contents,Photos,DateTime,Rate")] Comments comments)
        {
            if (ModelState.IsValid)
            {
