            ...
            return this.each(function() {
                ...
                function AddLists(){
                    ...
                    for(_x=0; _x<_dateSections.length; _x++){
                        ...
                        if(_dateSections[_x].toLowerCase().indexOf("y")>-1){
                            $('#' + _container_name).append("<span id='" + _container_name_year + "' class='day_container' style='margin:5px'>");
                            $('#' + _container_name_year).append("<select id='" + _container_name_year + "_list' name='" + _container_name_year + "_list' class='list'></select>");
                            $('#' + _container_name).append("</span>");
                        }
                        else if(_dateSections[_x].toLowerCase().indexOf("m")>-1){
                            $('#' + _container_name).append("<span id='" + _container_name_month + "' class='month_container'  style='margin:5px'>");
                            $('#' + _container_name_month).append("<select id='" + _container_name_month + "_list' name='" + _container_name_month + "_list' class='list'></select>");
                            $('#' + _container_name).append("</span>");                           
                        }
                        else if(_dateSections[_x].toLowerCase().indexOf("d")>-1){
                            $('#' + _container_name).append("<span id='" + _container_name_day + "' class='year_container'  style='margin:5px'>");
